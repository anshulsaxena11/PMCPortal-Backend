...
const VulnerabilityType = require('../models/switchLThreeModel');  // Import your model
...
async function seedDatabase() {
  const filePath = './switch-L3Vulnerability.xlsx'; // Replace with the actual file path
